...
function App() {
  ...
  // and narrow-band PCMU/PCMA (8 kHz).
  // ---------------------------------------------------------------------
  ...
  return (
    <div className="text-base flex flex-col h-screen bg-gray-100 text-gray-800 relative">
      <div className="p-5 text-lg font-semibold flex justify-between items-center">
        ...
        >
          <div className="mr-2">
            {/* Replaced OpenAI mark with BotsRHere mark */}
            <Image
              src="/botsrhere-logomark.svg"
              alt="BotsRHere Logo"
              width={20}
              height={20}
              priority
          ...
          <div>
            BotsRHere <span className="text-gray-500">Realtime Agents</span>
          </div>
        </div>
